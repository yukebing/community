    ...
    <div class="login">
        <div class="loginDiv">
            ...
            <div class="commondiv">
                ...
                <p><input type="msgCode" placeholder="请输入验证码" v-model="msgCode"></p>
                <button class="getCodeBtn" @click="getCode">{{getCodeBtnText}}</button>
            </div>
            <div class="commondiv clrarfix">
                <span class="fl"><span style="color: #999999;">还没有账号</span> <a class="blue" @click='go("register")'>注册</a></span>
                <a class="fr blue" @click='go("/")'>密码登录</a>
            </div>
            <div class="bottomBtn">
